# Outscal-Jobs -- Growth/Tech Jobs Harvester (fork of career-ops)
...
The underlying system was built by [santifer](https://santifer.io) to evaluate 740+ job offers, generate 100+ tailored CVs, and land a Head of Applied AI role. The archetypes, scoring logic, negotiation scripts, and proof point structure reflect his specific AI/automation career search.

The portfolio that goes with the original system is also open source: [cv-santiago](https://github.com/santifer/cv-santiago).

**It works out of the box, but is designed to be made yours.** You (AI Agent) can edit the user's files. The user says "change the archetypes to X" and you do it. That's the whole point.
